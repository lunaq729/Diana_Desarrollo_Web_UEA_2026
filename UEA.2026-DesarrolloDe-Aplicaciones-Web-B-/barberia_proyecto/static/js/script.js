document.addEventListener('DOMContentLoaded', () => {
    ...
    if (modalElement) {
        const modalWelcome = new bootstrap.Modal(modalElement);
        // Retardo de medio segundo para que la página cargue estilos primero
        setTimeout(() => {
            modalWelcome.show();
        }, 500);
    }
            ...
            colDiv.innerHTML = `
                <div class="card bg-dark border-secondary border-opacity-50 p-3 h-100 d-flex flex-column justify-content-between shadow">
                    ...
                    <div class="text-end pt-2 border-top border-secondary border-opacity-25">
                        <button class="btn btn-sm btn-outline-danger" onclick="eliminarReserva(${index})">
    ...
    // Hacer la función global para que el onclick del HTML pueda llamarla
    ...
    if (formReserva) {
        formReserva.addEventListener('submit', (e) => {
            ...
            if (v1 && v2 && v3) {
                ...
                alert("Por favor, completa correctamente todos los campos del turno.");
            }
        });
    }
